...
class MY_Model extends CI_Model {
    ...
    public function get_tablename($dbprefix=FALSE){
        return $dbprefix ? $this->db->dbprefix($this->_table_name) : $this->_table_name;
    }
    ...
    public function get_from_table($id = NULL, $single = FALSE,$where=null,$table, $method = 'result'){
        if ($id != NULL) {
            $filter = $this->_primary_filter;
            $id = $filter($id);
            $this->db->where($where);
    ...
    public function get_to_table($select,$where,$table){
    ...
    public function get_select_where($fields = '*', $where=NULL, $single= FALSE, $limit = FALSE, $offset=0, $order = FALSE){
     ...
     public function get_select_where_in_artist($fields = '*', $where=NULL, $single= FALSE, $limit = FALSE){
        $this->db->select($fields);
        if ($where) $this->db->where('mainArtistId in('.$where.')');
    ...
    public function get_select_where_in_song($fields = '*', $where=NULL, $single= FALSE, $limit = FALSE){
        $this->db->select($fields);
        if ($where) $this->db->where('mainSongId in('.$where.')');
    ...
    public function get_count_distinct($select='*',$where=NULL,$table=''){
        $this->db->select('count('.$select.') as found');
